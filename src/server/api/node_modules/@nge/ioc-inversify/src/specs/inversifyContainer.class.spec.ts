...
import { TestClass1A } from './testClass1A.class';
import { TestClass1B } from './testClass1B.class';
import { TestClass2A } from './testClass2A.class';
...
describe('InversifyContainer', () => {
    ...
    beforeEach(() => {
        ...
        inversifyContainerBuilder = new InversifyContainerBuilder(container);
