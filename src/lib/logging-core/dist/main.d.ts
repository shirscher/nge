...
export { ConsoleLogger, ConsoleLoggerFactory, ILogger, ILoggerFactory, LogLevel, MemoryLogger, MemoryLoggerFactory, NullLogger, NullLoggerFactory, initConsoleLogger, initMemoryLogger, initNullLogger };
/**
 * Registers the default logger implementation
 */
export declare const init: typeof initConsoleLogger;
